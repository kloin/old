			...
			protected JSONObject doInBackground(JSONObject... arg0) { 
		    	...
		    	if (requestCode.charAt(0) == '3') {
		    		...
		    		try {
			    	    ...
			    	    String urlString = "http://192.168.1.16:8080/tester/server/"+ 
				...
				try {
		    	    ...
		    	    //This is the restful request. Parameters passed in the url
		    	    URI url = new URI("http://192.168.1.16:8080/tester/server/?userId="+ entityId + "&trailId=" + entityId + 
		    	    		"&requestString="+requestCode + "&Description="+description + "&Title="+title+"&Photo=c:/");
